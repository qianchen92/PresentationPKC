...
% 
  ...
  \end{block}
    ...
    \item \visible<-2>{$\Sig.\KeyGen(\PPP) \to (\SSK^*, \SVK^*)$. \visible<2->{{\color{red} Do this at beginning}}}
    \item \visible<-2>{$\Com(\ck, \SVK^*) \to (\hat{\com}^*, \open^*)$. \visible<2->{{\color{red} Do this at beginning}}}
    \item Compute $\hat{\vec{u}}_{\hat{\com}} = \hat{\vec{u}}_2 \cdot (1, \hat{\com}) \in \hat{\G}^2$.	
